...
{
    //--------------------------------------------------------------------------
    // The main entry point for the jumpdir program. Returns the return code for
    // the entire program.
    //--------------------------------------------------------------------------
    ...
    // Ensure Version String Size;

    assert (c_version_string_length == _countof (c_verstring));
...
{
    //--------------------------------------------------------------------------
    // Print one line of debug information. The formatted string does not need a
    // carriage return.
    //
    // 'format' is the printf-style format string, and the remainder of the
    // arguments are as printf arguments also.
    //--------------------------------------------------------------------------
...
inline bool wstreqic (const wchar_t *str1, const wchar_t *str2)
{
    ...
    //
    // Parameters 'str1' and 'str2' are two const pointers to strings, which may
    // be null.
    //
    // This function returns true if the strings are non-null and equal to each
    // other, ignoring case.
    //--------------------------------------------------------------------------
